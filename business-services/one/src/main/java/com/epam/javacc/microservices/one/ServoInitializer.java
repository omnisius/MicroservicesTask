...
public class ServoInitializer {
    ...
    public void handleContextRefresh(ContextRefreshedEvent event) {
        ...
        MetricObserver o = new CounterToRateMetricTransform(new AsyncMetricObserver(GRAPHITE, new GraphiteMetricObserver(observerPrefix, address),
                queueSize, expireTime), heartbeat, TimeUnit.SECONDS);
        observers.add(o);
